...
//           nodes: [
//             { id: '1', position: { x: 50, y: 50 }, data: { label: 'Install NextAuth.js', status: 'Pending', icon: '📦' } },
//             { id: '2', position: { x: 50, y: 150 }, data: { label: 'Create [...nextauth].ts API Route', status: 'Pending', icon: '⚙️' } },
//           ],
...
//           folderStructure: `📁 client/\n📁 server/`,
//           nodes: [
//             { id: '1', position: { x: 50, y: 50 }, data: { label: 'Setup Express & Socket.IO Server', status: 'Pending', icon: '☁️' } },
//             { id: '2', position: { x: 50, y: 150 }, data: { label: 'Implement Client-side Socket Connection', status: 'Pending', icon: '🔌' } },
//           ],
//           edges: [ { id: 'e1-2', source: '1', target: '2' } ],
//         }
//       }
